...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
      ...
      #for j in range(te):
        ...
        loss = criterion(outputs, targets) + 0.1*(torch.abs(0.002*(sum_1 - (te*9*90))) + (0.000002*temp_2))
        loss.backward()
        optimizer.step()
    ...
    print("jjjjjjjjjjjj",0.000002*temp_2,"hhhhhhhhh",torch.abs(0.002*(sum_1 - (te*9*90))))
